% Unofficial University of South Carolina Poster Template
%https://people.stat.sc.edu/hoyen/Unofficial_Poster_Template_for_University_of_South_Carolina.jpg
...
\author{Yen-Yi Ho \inst{1} \and Ben Bitdiddle \inst{2} \and Lem E. Tweakit \inst{2}}
...
%  ABC Conference 2025, New York --- XYZ-1234 \hfill
 % \href{mailto:alyssa.p.hacker@example.com}{hoyen@stat.sc.edu}}
...
%\logoright{\includegraphics[height=7cm]{logos/usc_logo.eps}}
...
% logo: https://sc.edu/about/offices_and_divisions/communications/toolbox/visuals/logos/

\addtobeamertemplate{headline}{}
{
    \begin{tikzpicture}[remember picture,overlay]
      \node [anchor=north west, inner sep=3cm] at ([xshift=0.0cm,yshift=1.0cm]current page.north west)
      {\includegraphics[height=4.5cm]{logos/usc_logo.eps}}; 
    \end{tikzpicture}
}
